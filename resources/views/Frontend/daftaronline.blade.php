    ...
    <div data-aos="fade-up" class="py-10 bg-gray-50">
        ...
        <div data-aos="fade-up" class="container mx-auto px-4 lg:px-20 max-w-screen-lg">
            <div data-aos="fade-up" class="bg-white shadow-md rounded-lg overflow-hidden">
                <!-- Header -->
                <div data-aos="fade-up" class="bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] text-white p-6 text-center">
                    ...
                    <form method="post" action="{{ route('registration.store') }}">
                        ...
                        <div data-aos="fade-up" class="mt-6">
                            ...
                            <select name="kampus" data-aos="fade-up"
                                ...
                                <option value="POLITEKNIK ALKON KALIMANTAN"
                                    {{ old('kampus') == 'POLITEKNIK ALKON KALIMANTAN' ? 'selected' : '' }}>
                        ...
                        <div data-aos="fade-up" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <select name="jurusan" data-aos="fade-up"
                                    ...
                                    <!-- S1 Kelas Reguler -->
                                    <optgroup label="Diploma D3">
                                        @foreach ($data['Diploma D3'] as $jurusan)
                                            <option value="{{ $jurusan }}"
                                                {{ old('jurusan') == $jurusan ? 'selected' : '' }}>{{ $jurusan }}
                                            </option>
                                        @endforeach
                                    </optgroup>
                                    <optgroup label="Diploma D4">
                                        @foreach ($data['Diploma D4'] as $jurusan)
                                            <option value="{{ $jurusan }}"
                                                {{ old('jurusan') == $jurusan ? 'selected' : '' }}>{{ $jurusan }}
                                            </option>
                                        @endforeach
                        ...
                        <div data-aos="fade-up" class="mt-8 text-center">
                            <button type="submit" data-aos="fade-up"
                                class="w-full md:w-1/2 bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] hover:bg-gradient-to-br text-white py-3 rounded-lg  transition">
                                DAFTAR SEKARANG
                            </button>
                        </div>
                    </form>
