...
@section('content')
    <x-header-section-page title="Contact POLITEKNIK ALKON KALIMANTAN" breadcrumb-home="Home"
    ...
    <div data-aos="fade-up" class="py-10 bg-gray-50 shadow-xl mt-10">
        <div data-aos="fade-up" class="container mx-auto px-4 lg:px-16">
            <div data-aos="fade-up" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    <h2 data-aos="fade-up"
                        class="text-2xl font-poppins font-bold text-transparent bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] bg-clip-text mb-6">
                    ...
                    <form action="{{ route('store.fe-kontak') }}" method="POST" data-aos="fade-up" class="space-y-4">
                        ...
                        <div class="text-center">
                            <button type="submit"
                                class="w-full sm:w-1/2 bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] hover:bg-gradient-to-br text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div data-aos="fade-up" class="bg-white shadow-md rounded-lg p-6">
                    <h3 data-aos="fade-up"
                        class="text-xl font-semibold text-transparent bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] bg-clip-text mb-4 font-poppins">
                        Alamat Kampus &
                        Sekretariat</h3>
                    <p data-aos="fade-up" class="text-gray-600 mb-6 font-dmsans">Jl. Indrakila, Gn. Samarinda, Kec.
                        Balikpapan Utara, Kota Balikpapan, Kalimantan Timur 76124
                    </p>
                    <h3 data-aos="fade-up"
                        class="text-xl font-semibold text-transparent bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] bg-clip-text mb-4 font-poppins">
                        Call & SMS Center
