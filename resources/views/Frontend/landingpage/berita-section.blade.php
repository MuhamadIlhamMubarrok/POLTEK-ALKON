<div class="flex flex-col bg-contain bg-no-repeat bg-center justify-center px-4 md:px-[200px] my-[80px]"
    ...
    <div class="  flex flex-col md:items-start justify-center items-center w-full md:w-[40%] w-[100%] mt-4 md:mt-0"
        ...
        <x-header-section subtext="BERITA POLITEKNIK ALKON KALIMANTAN" subtext-color="#6b7280" title=""
            title-color="#D48B01" />
                            ...
                            <div class="px-[20px] flex flex-col gap-y-3 pt-[10px] pb-[20px]">
                                ...
                                <div class="mb-3 flex justify-start">
                                    <a href="{{ route('fe-detailberita', $project->id_berita) }}"
                                        class="text-white w-[140px] text-[9px] md:text-[11px] duration-200 md:w-[150px]  font-poppins bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] hover:bg-gradient-to-br font-normal rounded-full  px-4 md:px-2 md:pb-[7px] py-2.5 text-center me-2">
                                        BACA SELENGKAPNYA
                                    </a>
                                </div>
                            </div>
