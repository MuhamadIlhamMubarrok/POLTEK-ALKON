    ...
    <div class="py-10 bg-gray-50 shadow-xl mt-10">
        <div class="container mx-auto px-4 lg:px-20 max-w-screen-2xl">
            ...
            <x-join-us-section title="Bergabunglah Bersama POLITEKNIK ALKON KALIMANTAN"
                description="Politeknik Alkon Kalimantan menyiapkan Anda menjadi profesional handal dengan pendekatan pembelajaran yang aplikatif dan relevan dengan kebutuhan industri."
