<div data-aos="fade-up"
    class="h-auto w-full bg-cover bg-center bg-no-repeat flex flex-col md:flex-row px-4 py-6 md:px-8 md:py-10 lg:px-20 lg:py-15 gap-y-4 border-t-[5px]"
    style="background-image: url('{{ asset('./images/background/footer1.png') }}');">
    <div data-aos="fade-up" class="md:w-[60%] flex flex-col gap-y-5">
        <img src="{{ asset('./images/logo/logo1.png') }}" alt="logo aing" data-aos="fade-up" class="w-[200px]">
        <div data-aos="fade-up" class="flex flex-col md:flex-row text-white gap-y-5 md:gap-x-[200px]">
            <div data-aos="fade-up" class="text-start">
                <h1 data-aos="fade-up" class="font-bold font-montserrat uppercase text-base md:text-lg lg:text-xl">
                    POLITEKNIK ALKON KALIMANTAN
                </h1>
                <p data-aos="fade-up" class="w-full md:w-[400px] font-dmsans text-sm md:text-base lg:text-lg">Jl.
                    Indrakila, Gn. Samarinda, Kec. Balikpapan Utara, Kota Balikpapan, Kalimantan Timur 76124
                </p>
            </div>
        </div>
        <div data-aos="fade-up" class="flex flex-col md:flex-row text-white gap-y-5 md:gap-x-10 font-montserrat">
            <div data-aos="fade-up" class="text-start">
                <h1 data-aos="fade-up" class="font-bold uppercase text-base md:text-lg">Telephone</h1>
                <p data-aos="fade-up" class="text-sm md:text-base font-dmsans">+62 878-9019-8284</p>
            </div>
            <div>
                <h1 data-aos="fade-up" class="font-bold uppercase text-base md:text-lg">WhatsApp</h1>
                <p data-aos="fade-up" class="text-sm md:text-base font-dmsans">+62 878-9019-8284</p>
            </div>
            <div>
                <h1 data-aos="fade-up" class="font-bold uppercase text-base md:text-lg">Email</h1>
                <p data-aos="fade-up" class="text-sm md:text-base font-dmsans">info@kuliahkaryawan.net</p>
            </div>
        </div>
        <div class="flex flex-col text-white gap-y-1">
            <h1 class="font-semibold text-base md:text-lg font-montserrat uppercase">Sosial Media</h1>
            <div class="flex flex-row justify-start items-center gap-x-4 ">
                {{-- IG --}}
                <a href="https://www.instagram.com/k2.poltekalkon/" target="_blank">
                ...
                {{-- FACEBOOK --}}
                <a href="https://www.facebook.com/profile.php?id=61574162126125" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" class="hover:animate-pulse" width="35" height="35"
                        viewBox="-2 -2 24 24">
                        <g fill="#129A6A">
                            <path
    ...
    <p class="text-white text-l md:hidden lg:text-base text-center mt-3 font-montserrat">Copyright © 2024 -
        TEAM IT
        kuliahkaryawan
    </p>
    <div data-aos="fade-up" class="flex flex-col md:items-end md:justify-end items-start justify-center pb-2">
        <iframe
            src="https://www.google.com/maps/embed?pb=!4v1741842260449!6m8!1m7!1sT-OXwU5No770zhh4zjJawQ!2m2!1d-1.23572520506431!2d116.8455922824053!3f200.64517794608332!4f23.609527065867283!5f0.7820865974627469"
            class="hidden md:block md:w-[600px] h-[300px]" style="border:0;" allowfullscreen="" loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"></iframe>
        <p class="text-white text-xs md:text-sm lg:text-base text-center mt-3 font-montserrat">Copyright ©
            2024 - TEAM IT kuliahkaryawan
        </p>
        <x-footer></x-footer>
    </div>
</div>
