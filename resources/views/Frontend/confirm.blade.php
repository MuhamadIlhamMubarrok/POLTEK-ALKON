...
@section('content')
    <x-header-section-page title="Konfirmasi Pendaftaran POLITEKNIK ALKON KALIMANTAN" breadcrumb-home="Home"
    ...
    <div class="bg-gray-50 py-10">
        <div class="container mx-auto px-4 lg:px-20 max-w-screen-lg">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-accent">
                <!-- Header -->
                <div class="bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] text-white p-6 text-center">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-100 p-4 rounded-lg mt-2">
                            ...
                            <ul class="list-disc list-inside mt-2 text-sm">
                                <li>
                                    <a href="https://api.whatsapp.com/send?phone=6287890198284&text=Halo%20Admin%20Saya%20Sudah%20Daftar%20Online%20di%20POLITEKNIK ALKON KALIMANTAN"
                            ...
                            <div class="bg-gray-100 p-4 rounded-lg mt-2">
                                <form method="POST" action="app/formulir.php" data-aos="fade-up"
                                    ...
                                    <a href="{{ route('cetak.confirm', $registration->daftar_id) }}" data-aos="fade-up"
                                        class="bg-gradient-to-r from-[#129A6A] to-[#A5BBB6] hover:bg-gradient-to-br text-white text-sm font-poppins py-2 px-4 rounded-lg shadow-md hover:bg-accent transition">
                                        Cetak Formulir
                                    </a>
                                </form>
                            </div>
                ...
                <div class="bg-gray-100 p-6 text-center">
                    <img src="{{ asset('./images/logo/logo1.png') }}" alt="POLITEKNIK ALKON KALIMANTAN"
                        class="mx-auto w-32 mb-4">
                    <p class="text-sm font-poppins text-gray-600">POLITEKNIK ALKON KALIMANTAN
                    </p>
                </div>
            </div>
        </div>
