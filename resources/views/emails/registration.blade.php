...
<body>
    ...
    <ul>
        <li>Biaya Pendaftaran D3 : Rp. 150.000</li>
        <li>Biaya Pendaftaran D4 : Rp. 150.000</li>
    </ul>
    ...
    <p style="color: black; font-family: Arial, sans-serif;">
        ...
        Perguruan Tinggi: <b>POLITEKNIK ALKON KALIMANTAN</b><br>
    ...
    <p>Setelah melakukan pembayaran, konfirmasi dapat dilakukan melalui WA ke:
        <a
            href="https://api.whatsapp.com/send?phone=6287890198284&text=Halo%20Admin%20Saya%20Sudah%20Daftar%20Online%20di%20POLITEKNIK ALKON.">
            6287890198284
        </a>.
    </p>
</body>
